...
5. **Always read** `memory/error-log.md` — this is how i learn from mistakes
...
### 📋 Error Log (Auto-Capture)

- **ALWAYS load** in every session (main + shared contexts)
- Location: `memory/error-log.md`
- Purpose: Immediately log failures, corrections, gotchas, discoveries
- **When to log:**
