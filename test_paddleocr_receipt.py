#!/usr/bin/env python3
"""PaddleOCR Receipt Image Test

Creates a test receipt image and performs OCR on it.
...
def create_test_receipt():
    ...
    try:
        ...
        print(f"❌ Failed to create test receipt: {e}")
        return None
...
def test_paddleocr_receipt(image_path):
    ...
    try:
        ...
        # FIXED: Use predict instead of cls
...
def main():
    ...
    print("="*70)
    print("PaddleOCR Receipt Image Test")
